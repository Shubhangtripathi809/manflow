...
ALLOWED_HOSTS = config("ALLOWED_HOSTS", default="localhost,127.0.0.1,192.168.1.16").split(",")
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default="http://localhost:5173,http://127.0.0.1:5173,http://192.168.1.121:5173,http://192.168.1.21:5175"
).split(",")
